...
function CopyBtn({ text }) {
  ...
  return (
    <button onClick={copy} className="text-white hover:text-gold-light transition-colors">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bitzx-hover-lift bitzx-hover-glow bg-surface-DEFAULT border border-surface-border rounded-2xl p-6">
        <p className="text-white text-sm mb-1">Total Portfolio Value</p>
      ...
      <div className="bitzx-hover-lift bitzx-hover-glow bg-surface-DEFAULT border border-surface-border rounded-2xl p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-1">
            {['7D','1M','3M','1Y'].map(p => (
              <button key={p} className="px-2.5 py-1 text-xs rounded bg-surface-card text-white hover:text-white hover:bg-surface-hover transition-colors">
                {p}
              </button>
            ))}
          </div>
        ...
        <ResponsiveContainer width="100%" height={160}>
          <AreaChart data={CHART_DATA}>
            ...
            <XAxis dataKey="day" tick={{ fill:'#ffffff', fontSize:10 }} tickLine={false} axisLine={false} interval={6} />
